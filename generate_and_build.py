...
def run(config, prompts=None):
    ...
    try:
        ...
        from seo_optimizer import GeminiSEOOptimizer
        ...
        optimizer = GeminiSEOOptimizer(config)
    ...
    try:
        from site_generator import GeminiSiteGenerator
        site_gen = GeminiSiteGenerator(config)
        site_gen.build_site()
